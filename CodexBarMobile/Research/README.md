...
| 054 | Cost 分享编辑页与 Heatmap 模板 | `in-progress` | 2.0.0 (209) 正在完成当前 PR 审查修复与最终归档/TestFlight 交付；build 206 至 208 均已淘汰，App Review 与 Heatmap In-App Event 均保持未提交 | [054-cost-share-redesign/00-design.md](054-cost-share-redesign/00-design.md) | 2026-09-14 |
