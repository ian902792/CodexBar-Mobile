...
| 054 | Cost 分享编辑页与 Heatmap 模板 | `in-progress` | 三模板、全年 Heatmap、Provider 筛选和 iPhone/iPad 自适应布局完成；第二轮 PR 审查修复后将以 2.0.0 (206) 重新执行 Xcode 27 / iOS 27 测试、merge 与 TestFlight 上传 | [054-cost-share-redesign/00-design.md](054-cost-share-redesign/00-design.md) | 2026-09-14 |
