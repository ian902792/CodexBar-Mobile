...
| 054 | Cost 分享编辑页与 Heatmap 模板 | `done` | 2.0.0 (206) 已通过 Xcode 27 / iOS 27 测试、归档、TestFlight 上传与 Internal 分发；App Review 与 Heatmap In-App Event 均保持未提交 | [054-cost-share-redesign/00-design.md](054-cost-share-redesign/00-design.md) | 2026-09-14 |
